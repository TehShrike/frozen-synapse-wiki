...
e.exports=function(t,e){function s(t){console.log(t)}function a(){t.getPosts(function(t,e){t?s(t):v.set("postList",e.reverse().filter(function(t){return"string"==typeof t.metadata.title}).map(function(t){return{title:t.metadata.title,filename:t.filename}}))})}function u(e){t.getPost(e,function(t,n){t?(d.set("html",t.message),p.set("page",null),e!==i.errorPage&&(window.location=window.location.origin+window.location.pathname+i.pathPrefix+i.pagePathPrefix+i.errorPage)):(p.set("page",n.metadata.title),l?l(n):l=h.populateRootRactive(n,d),v.get("postList")||a())})}function c(t,e){function n(n){return n.filename===t&&n.title!==e.metadata.title}var r=v.get("postList")
r&&r.some(n)&&a()}var h=new o(t,e.linkify),f=Object.create(i),l=null,p=new r({el:"title",template:"{{title}}{{#page}} | {{page}}{{/page}}",data:{title:i.title}}),d=new r({el:"main",template:"#template-main",data:f}),g=i.sidebar?"{{{html}}}":"#template-menu",v=new r({el:"sidebar",template:g,data:f})
return i.sidebar&&t.getPost(i.sidebar,function(t,e){t?v.set("html",t.message):h.populateRootRactive(e,v)}),e.on("link",function(e){t.getPost(e,n)}),t.on("post changed",c),t.on("index changed",a),{setCurrent:u}}},{"noddity-renderer":89,ractive:99}],4:[function(t,e){var n=noddityConfig,r=t("events").EventEmitter
...
return t=u(this.options,t),new m(t,this,function(t){return e.db.iterator(t)})},i.prototype.keyStream=i.prototype.createKeyStream=function(t){return this.createReadStream(u(t,{keys:!0,values:!1}))},i.prototype.valueStream=i.prototype.createValueStream=function(t){return this.createReadStream(u(t,{keys:!1,values:!0}))},i.prototype.writeStream=i.prototype.createWriteStream=function(t){return new y(u(t),this)},i.prototype.toString=function(){return"LevelUP"},e.exports=i,e.exports.copy=b.copy,e.exports.destroy=o("destroy"),e.exports.repair=o("repair")}).call(this,t("Zh58VX"))},{"./batch":12,"./errors":13,"./read-stream":15,"./util":16,"./write-stream":17,Zh58VX:110,"deferred-leveldown":19,events:104,prr:25,util:131,xtend:36}],15:[function(t,e){function n(t,e,i){if(!(this instanceof n))return new n(t,e,i)
...
return"object"!=typeof e&&(e={}),this._written=!0,"function"==typeof this._write?this._write(n):"function"==typeof this._db._batch?this._db._batch(this._operations,e,n):void t.nextTick(n)},e.exports=n}).call(this,t("Zh58VX"))},{Zh58VX:110}],21:[function(t,e){e.exports=t(8)},{Zh58VX:110}],22:[function(t,e){(function(n,r){function i(t){if(!arguments.length||void 0===t)throw new Error("constructor requires at least a location argument")
if("string"!=typeof t)throw new Error("constructor requires a location string argument")
...
a.inherits(r,u),o(s(c.prototype),function(t){r.prototype[t]||(r.prototype[t]=c.prototype[t])})}).call(this,t("Zh58VX"))},{"./_stream_readable":28,"./_stream_writable":30,Zh58VX:110,"core-util-is":31,inherits:32}],27:[function(t,e){function n(t){return this instanceof n?void r.call(this,t):new n(t)}e.exports=n
...
for(var e=this._keys.length;e>=0;e--)this._keys[e]===t&&(this._keys.splice(e,1),window.localStorage.removeItem(t))},r.prototype.clear=function(){window.localStorage.clear()},r.prototype.length=function(){return this._keys.length},n.localStorage=r},{}],40:[function(t,e){e.exports=t(20)},{Zh58VX:110}],41:[function(t,e){e.exports=t(8)},{Zh58VX:110}],42:[function(t,e,n){arguments[4][22][0].apply(n,arguments)},{"./abstract-chained-batch":40,"./abstract-iterator":41,Zh58VX:110,buffer:101,xtend:44}],43:[function(t,e){function n(t){return null!==t&&("object"==typeof t||"function"==typeof t)}e.exports=n},{}],44:[function(t,e){function n(){for(var t={},e=0;e<arguments.length;e++){var n=arguments[e]
...
var h=u.batch
return u.batch=function(t,e,n){return Array.isArray(t)?(t.forEach(function(t){t.prefix&&("function"==typeof t.prefix.prefix?t.key=t.prefix.prefix(t.key):"string"==typeof t.prefix&&(t.key=t.prefix+t.key))}),void h.call(u,t,e,n)):new i(u)},u}}).call(this,t("Zh58VX"))},{"./batch":55,"./sub":67,Zh58VX:110,events:104,"level-fix-range":57,"level-hooks":59}],57:[function(t,e){var n=t("clone")
...
for(e=c.length;e--;)delete t[c[e]]}),s.unpatch=a,s}(R,c,M,P,q),V=function(t,e,n){var r,i,o
...
f=i.adapt[h]=t[f]}if(f.filter(a,s,i))return l=i._wrapped[s]=f.wrap(i,a,s,o(s)),l.value=a,a}return u||(i.magic?r.filter(a,s,i)?i._wrapped[s]=r.wrap(i,a,s):n.filter(a,s,i)&&(i._wrapped[s]=n.wrap(i,a,s)):i.modifyArrays&&e.filter(a,s,i)&&(i._wrapped[s]=e.wrap(i,a,s))),a}}(j,V,z,H),$=function(){function t(t,e){var n,r,i
...
i=e.root,o=e.keypath,s=e.priority,n=i._deps[s]||(i._deps[s]={}),r=n[o]||(n[o]=[]),r.push(e),e.registered=!0,o&&t(i,o)}}(),K=function(){function t(t,e){var n,r,i
...
i=n+"="+r,s=t.bindings,s[i]||(s[i]=!0,o=t.instance,a=t.parentFragment.priority,c=new u(e,n,o,r,a),s.push(c),o.twoway&&(h=new u(o,r,e,n,1),s.push(h),c.counterpart=h,h.counterpart=c))}}(w,R,I,d,$,K),J=function(t,e,n){function r(t,r,i,o,s){n(r,o,s,!0),e(r.component,t,i,o)}var i
...
while(o=o.parent)
return a=i(n,e),void 0!==a?(r(n,t,e,e,a),a):void 0}}(w,Z,U),G={FAILED_LOOKUP:!0},Q=function(t,e,n,r,i,o){function s(t,e,n){var s,u,c,h,f=t._cache
...
return a=i.split("."),u=a.pop(),c=a.join("."),h=s(t,c),(p=t._wrapped[c])&&(h=p.get()),null!==h&&void 0!==h?((f=t._cacheMap[c])?-1===f.indexOf(i)&&f.push(i):t._cacheMap[c]=[i],"object"!=typeof h||u in h?(d=!e.call(h,u),l=d?n(h[u]):h[u],l=r(t,i,l,!1),t._cache[i]=l,l):t._cache[i]=o):void 0}return t.get=s,s}(w,k,L,X,J,G),Y=function(){return"undefined"!=typeof console&&"function"==typeof console.warn&&"function"==typeof console.warn.apply?function(){console.warn.apply(console,arguments)}:function(){}}(),te=function(){var t=Object.prototype.toString
...
this.running=!1,e=this.root._animations.indexOf(this),-1===e&&t("Animation was not found"),this.root._animations.splice(e,1)}},i}(Y,R,ne,U),ie=function(t,e,n,r,i,o){function s(e,s,a,c){var h,f,l,p
...
y&&y.stop()}}}return r=r||{},r.complete&&i.then(r.complete),r.complete=o,c=s(this,t,n,r),i.stop=function(){c.stop()},i}}(d,g,v,C,Q,re),oe=function(){return this.fragment.detach()},se=function(t){return this.el?this.fragment.find(t):null},ae=function(t,e,n){var r,i,o,s,a,u,c
...
return v=o(l,p),m=new r(function(t){y=t}),t.start(this,y),i(this,a,c,!0),s(this,a,v,g),t.end(),h&&h.complete&&m.then(h.complete),m}}(R,Y,I,g,U,ke,Se),Oe=function(t,e,n){var r=function(t,e,n,r){var i=this
...
if(t=this.value,r=n(this.root,this.keypath),this.value=r,!this.updating){if(this.updating=!0,!e(r,t)||!this.ready)try{this.callback.call(this.context,r,t,this.keypath)}catch(i){if(this.debug||this.root.debug)throw i}this.updating=!1}}},r}(R,d,Q),Te=function(t){return function(e,n){var r,i,o,s,a,u,c
...
return this.proxies[t]||(this.proxies[t]={update:function(){e.reallyUpdate(t)}}),this.proxies[t]}},i}(R,d,Q,Te),Re=function(t,e,n,r,i){var o=/\*/,s={}
...
l&&(t=a._patternObservers.indexOf(f),-1!==t&&a._patternObservers.splice(t,1)),n(f)}}}}(v,$,K,Oe,Ae),Ce=function(t,e){return function(n,r,i){var o,s,a,u
if(t(n)){i=r,s=n,o=[]
...
"function"!=typeof t||t._nowrap||(t=o(t,this.root,this.evaluator)),e(t,this.value)||(this.evaluator.values[this.argNum]=t,this.evaluator.bubble(),this.value=t)},teardown:function(){i(this)}},s}(F,d,c,$,K),Ke=function(t,e,n){var r=function(t,n,r){this.root=t,this.keypath=n,this.priority=r.priority,this.evaluator=r,e(this)}
return r.prototype={update:function(){var e=this.root.get(this.keypath)
t(e,this.value)||(this.evaluator.bubble(),this.value=e)},teardown:function(){n(this)}},r}(d,$,K),Ze=function(t,e,n,r,i,o,s,a){function u(t,e){var n,r
...
this.selfUpdating=this.refs.length+this.softRefs.length<=1}},c}(R,Y,d,B,T,X,$e,Ke),Je=function(t,e,n,r,i){function o(t,e){return t.replace(/\$\{([0-9]+)\}/g,function(t,n){return e[n]?e[n].value||e[n].keypath:"undefined"})}function s(t){return"${"+t.replace(/[\.\[\]]/g,"-")+"}"}var a=function(r,i,o,s){var a,u,c,h=this
...
s.keypath&&(a=i(s.keypath,n,r))?(s.keypath=a,o=!0):s.indexRef===t&&(s.value=e,o=!0)}),o&&this.bubble()}},a}(E,N,Xe,Ze,Be),Ge=function(t,e,n,r,i,o,s){var a=function(i,o,a){var c,h,f,l,p,d=this
...
this.keypath=r,e(this),this.update()}}}(F,$,K),en=function(t){return function(e,n,r,i){var o,s
...
return t.replace(o,"&lt;").replace(s,"&gt;")}},i}(F,He,nn,Ve),on=function(){var t=[]
...
t(s),this.argsList=[i]}this.dirty=!1}return this.argsList}}(Y,Cn),Pn=function(t,e,n,r,i,o,s,a){var u=function(t){n.init(this,t)}
...
o.fn&&(i.decorator=o,t.addDecorator(i.decorator))}}(R,Vn),Hn=function(t,e){var n,r,i,o,s,a,u,c,h
...
e.index=n.index,e.keypath=n.keypath,e.context=n.root.get(n.keypath),n.events[t].fire(e)}},n}(Y,Pn),Xn=function(t){return function(e,n){var r,i,o
...
while(e=e._parent)},Kn=function(){if(this._inited)throw new Error("Cannot initialize a transition more than once")
...
return i}}(r,u,I,Zn),Gn=function(t){return function(e,n){var r
...
return this.running?t>this.end?(this.step&&this.step(1),this.complete&&this.complete(1),!1):(e=t-this.start,n=this.easing(e/this.duration),this.step&&this.step(n),!0):!1},stop:function(){this.abort&&this.abort(),this.running=!1}},i}(Y,b,C),tr=function(t){var e=new RegExp("^-(?:"+t.join("|")+")-")
...
return void t(u)}},u.prototype={init:n,getStyle:r,setStyle:i,animateStyle:o,processParams:s,resetStyle:a},u}(Y,Pn,Kn,Jn,Gn,rr,or,sr),ur=function(t,e){return function(n,r,i,o){var s,a,u
...
return n=e.pos,e.getStringMatch("(")?(e.allowWhitespace(),(r=e.getExpression())?(e.allowWhitespace(),e.getStringMatch(")")?{t:t.BRACKETED,x:r}:(e.pos=n,null)):(e.pos=n,null)):null}}(F),Wr=function(t,e,n){return function(r){return t(r)||e(r)||n(r)}}(Dr,Ur,qr),Vr=function(t,e){return function(n){var r,i,o
...
break}s={t:t.INVOCATION,x:s},u&&(s.o=u)}return s}}(F,Wr,Fr,Vr),Hr=function(t,e){var n,r
...
n=a}(),n}(F,zr),Xr=function(t,e){var n,r
...
n=a}(),n}(F,Hr),$r=function(t,e){return function(n){var r,i,o,s
return(i=e(n))?(r=n.pos,n.allowWhitespace(),n.getStringMatch("?")?(n.allowWhitespace(),(o=n.getExpression())?(n.allowWhitespace(),n.getStringMatch(":")?(n.allowWhitespace(),s=n.getExpression(),s?{t:t.CONDITIONAL,o:[i,o,s]}:(n.pos=r,i)):(n.pos=r,i)):(n.pos=r,i)):(n.pos=r,i)):null}}(F,Xr),Kr=function(t){return function(){return t(this)}}($r),Zr=function(t,e,n,r,i,o,s){var a
...
return i}}(F,Cn,N,Q,ki),Ni=function(){function t(t,e){var n,r,i
...
for(r in n)n.hasOwnProperty(r)&&e(t.instance,t.root,r,n[r])}}(Y),Ai=function(t){var e,n
...
d=[],p=n(a,l.data||{},u.descriptor.a,d),r(a,l,p,c,u.descriptor.f),i(a,d),o(a,u.descriptor.v),(u.descriptor.t1||u.descriptor.t2||u.descriptor.o)&&e('The "intro", "outro" and "decorator" directives have no effect on components'),s(a)}}(F,Y,Si,Ni,Oi,Ti,Ai),Ci=function(t,e){function n(t){var e,n
e=t.root
...
return n.prototype={detach:e,teardown:function(t){t&&this.detach()},firstNode:function(){return this.node},toString:function(){return"<!--"+this.descriptor.f+"-->"}},n}(F,Ve),Li=function(t,e,n,r,i,o,s,a,u,c,h,f,l){var p=function(t){t.pNode&&(this.docFrag=document.createDocumentFragment()),"string"==typeof t.descriptor?(this.html=t.descriptor,this.docFrag&&(this.nodes=r(this.html,t.pNode.tagName,t.pNode.namespaceURI,this.docFrag))):n.init(this,t)}
...
return"function"==typeof i?(o=i,i=""):i=i||"",s=new e(function(t){a=t}),t.start(this,a),n(this,i),r(this,i),t.end(),this.fire("update",i),o&&s.then(o.bind(this)),s}}(R,g,B,T),Vi=function(t,e,n){function r(t,i,o,s,a){var u,c,h,f,l,p
...
this.set(i)}}(x,yn,d),zi=function(t,e,n,r,i,o,s,a,u,c,h,f,l,p,d,g,v,m,y,b,w,E,_,x){return{add:t,animate:e,detach:n,find:r,findAll:i,findAllComponents:o,findComponent:s,fire:a,get:u,insert:c,merge:h,observe:f,off:l,on:p,render:d,renderHTML:g,reset:v,set:m,subtract:y,teardown:b,toHTML:w,toggle:E,update:_,updateModel:x}}(p,ie,oe,se,ve,me,ye,be,Ee,xe,Ne,Ce,Ie,Le,ji,Mi,Pi,Fi,Bi,Di,Ui,qi,Wi,Vi),Hi={},Xi={linear:function(t){return t},easeIn:function(t){return Math.pow(t,3)},easeOut:function(t){return Math.pow(t-1,3)+1},easeInOut:function(t){return(t/=.5)<1?.5*Math.pow(t,3):.5*(Math.pow(t-2,3)+2)}},$i=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(t){var e,n
return e=16*Math.random()|0,n="x"==t?e:3&e|8,n.toString(16)})},Ki=function(t){for(var e,n,r=Array.prototype.slice.call(arguments,1);n=r.shift();)for(e in n)n.hasOwnProperty(e)&&(t[e]=n[e])
return t},Zi=["adaptors","components","decorators","easing","events","interpolators","partials","transitions","data"],Ji=function(){function t(t){return t.trim?t.trim():t.replace(/^\s+/,"").replace(/\s+$/,"")}function e(t){return t.str}var n=/(?:^|\})?\s*([^\{\}]+)\s*\{/g,r=/\/\*.*?\*\//g,i=/((?:(?:\[[^\]+]\])|(?:[^\s\+\>\~:]))+)((?::[^\s\+\>\~]+)?\s*[\s\+\>\~]?)\s*/g
...
return r=n.split(",").map(t),i=r.map(u).join(", ")+" ",e.replace(n,i)})}}(),Gi=function(t,e,n,r){return function(i,o){t.forEach(function(t){o[t]&&(i[t]=e(o[t]))}),n(i,"defaults",{value:e(o.defaults)}),o.css&&n(i,"css",{value:o.defaults.noCssTransform?o.css:r(o.css,i._guid)})}}(Zi,je,c,Ji),Qi=function(t,e){return/_super/.test(t)?function(){var n,r=this._super
...
u.css&&n(a,"css",{value:a.defaults.noCssTransform?u.css:o(u.css,a._guid)})}}(i,Zi,c,Qi,Yi,Ji),eo=function(t,e){return function(n,r){t(n.defaults.template)&&(n.partials||(n.partials={}),e(n.partials,n.defaults.template.partials),r.partials&&e(n.partials,r.partials),n.defaults.template=n.defaults.template.main)}}(te,Yi),no=function(t,e,n){return function(r){var i
...
e=this.root.get(this.keypath),t(e,this.value)||this.computation.bubble()},teardown:function(){n(this)}},r}(d,$,K),so=function(t,e,n,r){function i(t,e,n){var i,o,s
...
n=this._subs[t],n&&(r=n.indexOf(e),-1!==r&&n.splice(r,1))}}(),V=function(){return function(t){var e,n,r,i,o,s,a,u
...
if(e.splice(n,1),t.registered=!1,a)for(r=a.split(".");r.length;)r.pop(),i=r.join("."),o=s._depsMap[i],o[a]-=1,o[a]||(o.splice(o.indexOf(a),1),o[a]=void 0),a=i}}(),H=function(t){var e=function(t,e,n,r){var i=this
this.root=t,this.keypath=e,this.callback=n,this.defer=r.defer,this.debug=r.debug,this.proxy={update:function(){i.reallyUpdate()}},this.priority=0,this.context=r&&r.context?r.context:t}
...
if(e=this.value,n=this.root.get(this.keypath),this.value=n,!this.updating){if(this.updating=!0,!t(n,e)||!this.ready)try{this.callback.call(this.context,n,e,this.keypath)}catch(r){if(this.debug||this.root.debug)throw r}this.updating=!1}}},e}(k),X=function(){return function(t,e){var n,r,i,o,s,a,u
...
return i={},o.forEach(function(e){i[e]=t.get(e)}),i}}(),$=function(t,e){var n,r=/\*/
...
return this.proxies[t]||(this.proxies[t]={update:function(){e.reallyUpdate(t)}}),this.proxies[t]}},n}(k,X),K=function(t,e,n,r,i){var o=/\*/,s={}
return function(a,u,c,h){var f,l
return u=t(u),h=h||s,o.test(u)?(f=new i(a,u,c,h),a._patternObservers.push(f),l=!0):f=new r(a,u,c,h),e(f),f.init(h.init),f.ready=!0,{cancel:function(){var t
l&&(t=a._patternObservers.indexOf(f),-1!==t&&a._patternObservers.splice(t,1)),n(f)}}}}(c,V,z,H,$),Z=function(t,e){return function(n,r,i){var o,s=[]
if(t(n)){i=r
for(o in n)n.hasOwnProperty(o)&&(r=n[o],s[s.length]=e(this,o,r,i))
return{cancel:function(){for(;s.length;)s.pop().cancel()}}}return e(this,n,r,i)}}(x,K),J=function(){return function(t){var e,n,r,i=this._subs[t]
if(i)for(e=Array.prototype.slice.call(arguments,1),n=0,r=i.length;r>n;n+=1)i[n].apply(this,e)}}(),G=function(){return function(t){return this.el?this.fragment.find(t):null}}(),Q=function(t,e){var n,r,i,o,s,a,u,c
...
for(n=(t.parentNode||t.document).querySelectorAll(e),r=n.length;r--;)if(n[r]===t)return!0
return!1}}}(s,o),Y=function(t){return function(e,n){var r=this._isComponentQuery?!this.selector||e.name===this.selector:t(e.node,this.selector)
return r?(this.push(e.node||e.instance),n||this._makeDirty(),!0):void 0}}(Q),te=function(){return function(){var t,e,n
...
return h=[],t(h,{selector:{value:a},live:{value:u},_isComponentQuery:{value:c},_test:{value:e}}),u?(t(h,{cancel:{value:n},_root:{value:s},_sort:{value:r},_makeDirty:{value:i},_remove:{value:o},_dirty:{value:!1,writable:!0}}),h):h}}(u,Y,te,re,ie,oe),ae=function(t,e,n,r){return function(t,e){var n,i
return this.el?(e=e||{},n=this._liveQueries,(i=n[t])?e&&e.live?i:i.slice():(i=r(this,t,!!e.live,!1),i.live&&(n.push(t),n[t]=i),this.fragment.findAll(t,i),i)):[]}}(M,Q,u,se),ue=function(){return function(t){return this.fragment.findComponent(t)}}(),ce=function(t,e,n,r){return function(t,e){var n,i
return e=e||{},n=this._liveComponentQueries,(i=n[t])?e&&e.live?i:i.slice():(i=r(this,t,!!e.live,!0),i.live&&(n.push(t),n[t]=i),this.fragment.findAllComponents(t,i),i)}}(M,Q,u,se),he=function(){return function(t){var e
...
return a=/this/,s=function(e,n,i,s,a){var u
this.evaluator=i,this.keypath=n,this.root=e,this.argNum=s,this.type=t.REFERENCE,this.priority=a,u=e.get(n),"function"==typeof u&&(u=o(u,e,i)),this.value=i.values[s]=u,r(this)},s.prototype={update:function(){var t=this.root.get(this.keypath)
"function"!=typeof t||t._nowrap||(t=o(t,this.root,this.evaluator)),e(t,this.value)||(this.evaluator.values[this.argNum]=t,this.evaluator.bubble(),this.value=t)},teardown:function(){i(this)}},s}(f,k,a,V,z),ve=function(t,e,n){var r=function(t,n,r){this.root=t,this.keypath=n,this.priority=r.priority,this.evaluator=r,e(this)}
return r.prototype={update:function(){var e=this.root.get(this.keypath)
t(e,this.value)||(this.evaluator.bubble(),this.value=e)},teardown:function(){n(this)}},r}(k,V,z),me=function(t,e,n,r,i,o,s,a,u){function c(t,e){var n,r
...
this.selfUpdating=this.refs.length+this.softRefs.length<=1}},h}(k,a,p,y,V,z,E,ge,ve),ye=function(t,e){var n=function(e,n,r,i){var o,s
...
for(s=[],r(n,i,s),a=s.length;a--;)u=s[a],e(u),u.keypath=u.keypath.replace(i,o),t(u),u.update()}}(V,z),_e=function(t,e,n,r){var i=function(t){var n,r,i,o,s
...
for(r=this.nodes.length,n=0;r>n;n+=1)if(i=this.nodes[n],1===i.nodeType){if(e(i,t))return i
if(o=i.querySelector(t))return o}return null},findAll:function(t,n){var r,i,o,s,a,u
for(i=this.nodes.length,r=0;i>r;r+=1)if(o=this.nodes[r],1===o.nodeType&&(e(o,t)&&n.push(o),s=o.querySelectorAll(t)))for(a=s.length,u=0;a>u;u+=1)n.push(s[u])}},a}(f,Q,xe,Se,ke,le,de),je=function(t){return function(e,n){return e.a&&e.a.xmlns?e.a.xmlns:"svg"===e.e?t.svg:n.namespaceURI||t.html}}(i),Me=function(){var t,e,n,r
return t="altGlyph altGlyphDef altGlyphItem animateColor animateMotion animateTransform clipPath feBlend feColorMatrix feComponentTransfer feComposite feConvolveMatrix feDiffuseLighting feDisplacementMap feDistantLight feFlood feFuncA feFuncB feFuncG feFuncR feGaussianBlur feImage feMerge feMergeNode feMorphology feOffset fePointLight feSpecularLighting feSpotLight feTile feTurbulence foreignObject glyphRef linearGradient radialGradient textPath vkern".split(" "),e="attributeName attributeType baseFrequency baseProfile calcMode clipPathUnits contentScriptType contentStyleType diffuseConstant edgeMode externalResourcesRequired filterRes filterUnits glyphRef gradientTransform gradientUnits kernelMatrix kernelUnitLength keyPoints keySplines keyTimes lengthAdjust limitingConeAngle markerHeight markerUnits markerWidth maskContentUnits maskUnits numOctaves pathLength patternContentUnits patternTransform patternUnits pointsAtX pointsAtY pointsAtZ preserveAlpha preserveAspectRatio primitiveUnits refX refY repeatCount repeatDur requiredExtensions requiredFeatures specularConstant specularExponent spreadMethod startOffset stdDeviation stitchTiles surfaceScale systemLanguage tableValues targetX targetY textLength viewBox viewTarget xChannelSelector yChannelSelector zoomAndPan".split(" "),n=function(t){for(var e={},n=t.length;n--;)e[t[n].toLowerCase()]=t[n]
return e},r=n(t.concat(e)),function(t){var e=t.toLowerCase()
...
return function(){var e=t.exec(this.remaining())
return e?(this.pos+=e[0].length,e[0]):null}}(),Ve=function(){return function(t){return function(e){var n=t.exec(e.str.substring(e.pos))
...
return r||null}}(),He=function(t,e){var n=t(/^[^\\"]+/),r=t(/^[^\\']+/)
return function i(t,o){var s,a,u,c,h,f
if(s=t.pos,a="",f=o?r:n,u=e(t),u&&(a+=u),c=f(t),c&&(a+=c),!a)return""
for(h=i(t,o);""!==h;)a+=h
return a}}(Ve,ze),Xe=function(t,e){return function(n){var r,i
return r=n.pos,n.getStringMatch('"')?(i=e(n,!1),n.getStringMatch('"')?{t:t.STRING_LITERAL,v:i}:(n.pos=r,null)):n.getStringMatch("'")?(i=e(n,!0),n.getStringMatch("'")?{t:t.STRING_LITERAL,v:i}:(n.pos=r,null)):null}}(f,He),$e=function(t,e){var n=e(/^(?:[+-]?)(?:(?:(?:0|[1-9]\d*)?\.\d+)|(?:(?:0|[1-9]\d*)\.)|(?:0|[1-9]\d*))(?:[eE][+-]?\d+)?/)
return function(e){var r
return(r=n(e))?{t:t.NUMBER_LITERAL,v:r}:null}}(f,Ve),Ke=function(t){return t(/^[a-zA-Z_$][a-zA-Z_$0-9]*/)}(Ve),Ze=function(t,e,n){var r=/^[a-zA-Z_$][a-zA-Z_$0-9]*$/
return function(i){var o
return(o=t(i))?r.test(o.v)?o.v:'"'+o.v.replace(/"/g,'\\"')+'"':(o=e(i))?o.v:(o=n(i))?o:void 0}}(Xe,$e,Ke),Je=function(t,e,n,r){function i(t){var e,n,i
return t.allowWhitespace(),(e=r(t))?(i={key:e},t.allowWhitespace(),t.getStringMatch(":")?(t.allowWhitespace(),(n=t.getToken())?(i.value=n.v,i):null):null):null}var o,s,a,u,c,h
return s={"true":!0,"false":!1,undefined:void 0,"null":null},a=new RegExp("^(?:"+Object.keys(s).join("|")+")"),u=/^(?:[+-]?)(?:(?:(?:0|[1-9]\d*)?\.\d+)|(?:(?:0|[1-9]\d*)\.)|(?:0|[1-9]\d*))(?:[eE][+-]?\d+)?/,c=/\$\{([^\}]+)\}/g,h=/^\$\{([^\}]+)\}/,o=function(t,e){this.str=t,this.values=e,this.pos=0,this.result=this.getToken()},o.prototype={remaining:function(){return this.str.substring(this.pos)},getStringMatch:t,getToken:function(){return this.allowWhitespace(),this.getPlaceholder()||this.getSpecial()||this.getNumber()||this.getString()||this.getObject()||this.getArray()},getPlaceholder:function(){var t
return this.values?(t=h.exec(this.remaining()))&&this.values.hasOwnProperty(t[1])?(this.pos+=t[0].length,{v:this.values[t[1]]}):void 0:null},getSpecial:function(){var t
return(t=a.exec(this.remaining()))?(this.pos+=t[0].length,{v:s[t[0]]}):void 0},getNumber:function(){var t
...
for(t=[];e=this.getToken();){if(t.push(e.v),this.getStringMatch("]"))return{v:t}
if(!this.getStringMatch(","))return null}return null},allowWhitespace:e},function(t,e){var n=new o(t,e)
return n.result?{value:n.result.v,remaining:n.remaining()}:null}}(qe,We,Xe,Ze),Ge=function(t,e,n,r,i){function o(t){return"string"==typeof t?t:JSON.stringify(t)}var s=function(e){this.type=t.INTERPOLATOR,n(this,e)}
return s.prototype={update:r,resolve:i,render:function(t){this.value=t,this.parentFragment.bubble()},teardown:function(){e(this)},toString:function(){return void 0==this.value?"":o(this.value)}},s}(f,de,xe,Se,ke),Qe=function(t,e,n,r,i,o,s){var a,u
...
t(s),this.argsList=[i]}this.dirty=!1}return this.argsList}}(M,Je),en=function(t,e,n,r,i,o,s,a){var u=function(t){n(this,t)}
...
if(r)return!1
r=!0}return this.simple=!0},toString:function(){return this.items.join("")},toJSON:function(){var t,n=this.getValue()
return"string"==typeof n&&(t=e(n),n=t?t.value:n),n},toArgsList:s},a.StringFragment=u,u}(f,Je,fe,Ge,Qe,Ye,tn,Ce),nn=function(t,e,n,r,i,o,s){var a=function(i){return this.type=t.ATTRIBUTE,this.element=i.element,e(this,i.name),null===i.value||"string"==typeof i.value?void n(this,i):(this.root=i.root,this.pNode=i.pNode,this.parentFragment=this.element.parentFragment,this.fragment=new s({descriptor:i.value,root:this.root,owner:this,contextStack:i.contextStack}),void(this.pNode&&("value"===this.name&&(this.isValueAttribute=!0,"INPUT"===this.pNode.tagName&&"file"===this.pNode.type&&(this.isFileInputValue=!0)),r(this,i),this.selfUpdating=this.fragment.isSimple(),this.ready=!0)))}
...
return t(this.node,e)?this.node:this.html&&(n=this.node.querySelector(e))?n:this.fragment&&this.fragment.find?this.fragment.find(e):void 0}}(Q),wn=function(){return function(t,e){var n,r,i,o,s
...
return function(t){var n,r,i
return t.getStringMatch("=")?(n=t.pos,t.allowWhitespace(),(r=e(t))?(t.allowWhitespace(),(i=e(t))?(t.allowWhitespace(),t.getStringMatch("=")?[r,i]:(t.pos=n,null)):(t.pos=n,null)):(t.pos=n,null)):null}}(Ve),Cn=function(t){var e={"#":t.SECTION,"^":t.INVERTED,"/":t.CLOSING,">":t.PARTIAL,"!":t.COMMENT,"&":t.TRIPLE}
return function(t){var n=e[t.str.charAt(t.pos)]
...
return c.t===t.REFERENCE?a.ref=c.n:c.t===t.NUMBER_LITERAL&&i.test(c.v)?a.ref=c.v:a.expression=c,h=r(e),null!==h&&(a.indexRef=h),a}}(f,Ve,Cn),Ln=function(t,e,n){function r(r,i){var o,s,a=r.pos
return s=i?r.tripleDelimiters:r.delimiters,r.getStringMatch(s[0])?(o=e(r))?r.getStringMatch(s[1])?(r[i?"tripleDelimiters":"delimiters"]=o,{type:t.MUSTACHE,mustacheType:t.DELIMCHANGE}):(r.pos=a,null):(r.allowWhitespace(),o=n(r,i),null===o?(r.pos=a,null):(r.allowWhitespace(),r.getStringMatch(s[1])?o:(r.pos=a,null))):null}return function(){var t=this.tripleDelimiters[0].length>this.delimiters[0].length
...
return t.getStringMatch(e)?r:(t.pos=n,null)},d=function(e,r){var i,o,s
if(i=e.pos,s=e.remaining(),o=n(s,[r,e.delimiters[0],e.delimiters[1]]),-1===o)throw new Error("Quoted attribute value must have a closing quote")
return o?(e.pos+=o,{type:t.TEXT,value:s.substr(0,o)}):null},r}(f,Ve,Mn),Fn=function(t,e){return function(){var n,r,i
...
return r=n.pos,n.allowWhitespace(),i=e(n),null===i?(n.pos=r,null):(n.allowWhitespace(),n.getStringMatch(":")?(n.allowWhitespace(),o=n.getExpression(),null===o?(n.pos=r,null):{t:t.KEY_VALUE_PAIR,k:i,v:o}):(n.pos=r,null))}}(f,Ze),Un=function(t){return function e(n){var r,i,o,s
...
r=r.concat(o)}return r}}(),Vn=function(t,e){return function(n){var r,i
...
return s}}($e,Bn,Xe,qn,Vn),Hn=function(t,e,n){var r,i,o,s
return r=e(/^\.[a-zA-Z_$0-9]+/),i=function(t){var e=o(t)
return e?"."+e:null},o=e(/^\[(0|[1-9][0-9]*)\]/),s=/^(?:Array|Date|RegExp|decodeURIComponent|decodeURI|encodeURIComponent|encodeURI|isFinite|isNaN|parseFloat|parseInt|JSON|Math|NaN|undefined|null)$/,function(e){var o,a,u,c,h,f,l
for(o=e.pos,a="";e.getStringMatch("../");)a+="../"
if(a||(c=e.getStringMatch(".")||""),u=n(e)||"",!a&&!c&&s.test(u))return{t:t.GLOBAL,v:u}
if("this"!==u||a||c||(u=".",o+=3),h=(a||c)+u,!h)return null
for(;f=r(e)||i(e);)h+=f
return e.getStringMatch("(")&&(l=h.lastIndexOf("."),-1!==l?(h=h.substr(0,l),e.pos=o+h.length):e.pos-=1),{t:t.REFERENCE,n:h}}}(f,Ve,Ke),Xn=function(t){return function(e){var n,r
return n=e.pos,e.getStringMatch("(")?(e.allowWhitespace(),(r=e.getExpression())?(e.allowWhitespace(),e.getStringMatch(")")?{t:t.BRACKETED,x:r}:(e.pos=n,null)):(e.pos=n,null)):null}}(f),$n=function(t,e,n){return function(r){return t(r)||e(r)||n(r)}}(zn,Hn,Xn),Kn=function(t,e){return function(n){var r,i,o
if(r=n.pos,n.allowWhitespace(),n.getStringMatch(".")){if(n.allowWhitespace(),i=e(n))return{t:t.REFINEMENT,n:i}
n.expected("a property name")}return n.getStringMatch("[")?(n.allowWhitespace(),o=n.getExpression(),o||n.expected("an expression"),n.allowWhitespace(),n.getStringMatch("]")||n.expected('"]"'),{t:t.REFINEMENT,x:o}):null}}(f,Ke),Zn=function(t,e,n,r){return function(i){var o,s,a,u
if(s=e(i),!s)return null
for(;s;)if(o=i.pos,a=r(i))s={t:t.MEMBER,x:s,r:a}
else{if(!i.getStringMatch("("))break
if(i.allowWhitespace(),u=n(i),i.allowWhitespace(),!i.getStringMatch(")")){i.pos=o
break}s={t:t.INVOCATION,x:s},u&&(s.o=u)}return s}}(f,$n,Wn,Kn),Jn=function(t,e){var n,r
return r=function(e,n){return function(r){var i,o
return r.getStringMatch(e)?(i=r.pos,r.allowWhitespace(),o=r.getExpression(),o||r.expected("an expression"),{s:e,o:o,t:t.PREFIX_OPERATOR}):n(r)}},function(){var t,i,o,s,a
for(s="! ~ + - typeof".split(" "),a=e,t=0,i=s.length;i>t;t+=1)o=r(s[t],a),a=o
n=a}(),n}(f,Zn),Gn=function(t,e){var n,r
return r=function(e,n){return function(r){var i,o,s
...
for(s="* / % + - << >> >>> < <= > >= in instanceof == != === !== & ^ | && ||".split(" "),a=e,t=0,i=s.length;i>t;t+=1)o=r(s[t],a),a=o
n=a}(),n}(f,Jn),Qn=function(t,e){return function(n){var r,i,o,s
return(i=e(n))?(r=n.pos,n.allowWhitespace(),n.getStringMatch("?")?(n.allowWhitespace(),(o=n.getExpression())?(n.allowWhitespace(),n.getStringMatch(":")?(n.allowWhitespace(),s=n.getExpression(),s?{t:t.CONDITIONAL,o:[i,o,s]}:(n.pos=r,i)):(n.pos=r,i)):(n.pos=r,i)):(n.pos=r,i)):null}}(f,Gn),Yn=function(t){return function(){return t(this)}}(Qn),tr=function(t,e,n,r,i,o,s){var a
return a=function(t,e){var n
...
return t},getMustache:t,getComment:e,getTag:n,getText:r,getExpression:i,allowWhitespace:o,getStringMatch:s,remaining:function(){return this.str.substring(this.pos)},fail:function(){var t,e
throw t=this.str.substr(0,this.pos).substr(-20),20===t.length&&(t="..."+t),e=this.remaining().substr(0,20),20===e.length&&(e+="..."),new Error("Could not parse template: "+(t?t+"<- ":"")+"failed at character "+this.pos+" ->"+e)},expected:function(t){var e=this.remaining().substr(0,40)
throw 40===e.length&&(e+="..."),new Error('Tokenizer failed: unexpected string "'+e+'" (expected '+t+")")}},a}(Ln,jn,Pn,Fn,Yn,We,qe),er=function(t,e,n,r,i){var o,s
...
return c=c.concat(i),r.name=1===u.length&&u[0].type===t.TEXT?u[0].value:u,c.length&&(1===c.length&&c[0].type===t.TEXT?(h=e("["+c[0].value+"]"),r.args=h?h.value:c[0].value):r.dynamicArgs=c),r}}(f,Je),gr=function(t,e){var n
return n=function(t,e){var n
for(this.tokens=t||[],this.pos=0,this.options=e,this.result=[];n=this.getStub();)this.result.push(n)},n.prototype={getStub:function(){var t=this.next()
...
return r}}(f,Je,S,Nr),Tr=function(){return function(t,e,n,r,i){var o,s,a,u
...
return null}},findAllComponents:function(t,e){var n,r,i
if(this.items)for(r=this.items.length,n=0;r>n;n+=1)i=this.items[n],i.findAllComponents&&i.findAllComponents(t,e)
return e}},l.DomFragment=p,p}(f,Q,fe,le,pe,Ne,Ie,Le,kn,Sr,Lr,jr,Ce),Pr=function(t,e,n,r,i){return function(t,o){var s
...
else if(e.debug)throw new Error("Cannot add to a non-numeric value")}else if(e.debug)throw new Error("Bad arguments")}}(P),qr=function(t){return function(e,n){t(this,e,void 0===n?1:n)}}(Ur),Wr=function(t){return function(e,n){t(this,e,void 0===n?-1:-n)}}(Ur),Vr=function(){return function(t){var e
...
a=o+1}while(n[o]&&u>a)
return o===i&&(i+=1),o!==r&&(s=!0),n[o]=!0,o},o=t.map(r),o.unchanged=!s,o}}(),Hr=function(t){return function(e,n,r,i){var o,s
for(o=n.length;o--;)s=n[o],s.type===t.REFERENCE?s.update():s.keypath===e&&s.type===t.SECTION&&!s.inverted&&s.docFrag?r[r.length]=s:i[i.length]=s}}(f),Xr=function(t,e,n,r,i,o,s,a,u,c){function h(t){return JSON.stringify(t)}function f(t){return l[t]||(l[t]=function(e){return e[t]}),l[t]}var l={}
...
s.multiple(this,T,!0),v.length!==m.length&&s(this,l+".length",!0),this._transitionManager=O,N.ready()}}}(M,l,p,g,O,m,y,T,zr,Hr),$r=function(){return function(){return this.fragment.detach()}}(),Kr=function(t){return function(e,n){if(e=t(e),n=t(n)||null,!e)throw new Error("You must specify a valid target to insert into")
e.insertBefore(this.detach(),n),this.fragment.pNode=e}}(he),Zr=function(t,e,n,r,i,o,s,a,u,c,h,f,l,p,d,g,v,m,y,b,w,E,_){return{get:t,set:e,update:n,updateModel:r,animate:i,on:o,off:s,observe:a,fire:u,find:c,findAll:h,findComponent:f,findAllComponents:l,renderHTML:d,toHTML:g,render:p,teardown:v,add:m,subtract:y,toggle:b,merge:w,detach:E,insert:_}}(_,A,R,I,U,q,W,Z,J,G,ae,ue,ce,Pr,Fr,Br,Dr,qr,Wr,Vr,Xr,$r,Kr),Jr=function(){return["partials","transitions","events","components","decorators","data"]}(),Gr=function(){return["el","template","complete","modifyArrays","magic","twoway","lazy","append","preserveWhitespace","sanitize","stripComments","noIntro","transitionsEnabled","adaptors"]}(),Qr=function(t,e,n){return function(r,i){t.forEach(function(t){i[t]&&(r[t]=n(i[t]))}),e.forEach(function(t){r[t]=i[t]})}}(Jr,Gr,r),Yr=function(){return function(t,e){return/_super/.test(t)?function(){var n,r=this._super
...
for(a in s)s.hasOwnProperty(a)&&!o[a]&&(u=s[a],i.prototype[a]="function"==typeof u&&"function"==typeof i.prototype[a]?n(u,i.prototype[a]):u)}}(Jr,Gr,Yr,ti),ni=function(t,e){return function(n,r){t(n.template)&&(n.partials||(n.partials={}),e(n.partials,n.template.partials),r.partials&&e(n.partials,r.partials),n.template=n.template.main)}}(x,ti),ri=function(t,e,n){return function(r){var i
...
else if(C(t))if(r.isBuffer(t))for(a=0;i>a;a++)s[a]=t.readUInt8(a)
...
return i}function h(t,e,n){return V.fromByteArray(0===e&&n===t.length?t:t.slice(e,n))}function f(t,e,n){var r="",i=""
...
var o=t.length
if(!(n>=o))return e>=0?x(t,e,n,r,i):x(t,4294967295+e+1,n,r,i),n+4}function N(t,e,n,r,i){i||(W(void 0!==e&&null!==e,"missing value"),W("boolean"==typeof r,"missing or invalid endian"),W(void 0!==n&&null!==n,"missing offset"),W(n+3<t.length,"Trying to write beyond buffer length"),q(e,3.4028234663852886e38,-3.4028234663852886e38))
var o=t.length
if(!(n>=o))return z.write(t,e,n,r,23,4),n+4}function O(t,e,n,r,i){i||(W(void 0!==e&&null!==e,"missing value"),W("boolean"==typeof r,"missing or invalid endian"),W(void 0!==n&&null!==n,"missing offset"),W(n+7<t.length,"Trying to write beyond buffer length"),q(e,1.7976931348623157e308,-1.7976931348623157e308))
var o=t.length
if(!(n>=o))return z.write(t,e,n,r,52,8),n+8}function T(t){for(t=A(t).replace(X,"");t.length%4!==0;)t+="="
return t}function A(t){return t.trim?t.trim():t.replace(/^\s+|\s+$/g,"")}function R(t){return(Array.isArray||function(t){return"[object Array]"===Object.prototype.toString.call(t)})(t)}function C(t){return R(t)||r.isBuffer(t)||t&&"object"==typeof t&&"number"==typeof t.length}function I(t){return 16>t?"0"+t.toString(16):t.toString(16)}function L(t){for(var e=[],n=0;n<t.length;n++){var r=t.charCodeAt(n)
if(127>=r)e.push(r)
else{var i=n
r>=55296&&57343>=r&&n++
...
break
default:throw new Error("Unknown encoding")}return n},r.concat=function(t,e){if(W(R(t),"Usage: Buffer.concat(list[, length])"),0===t.length)return new r(0)
...
var X=/[^+\/0-9A-z]/g},{"base64-js":102,ieee754:103}],102:[function(t,e,n){var r="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"
...
var V=r.indexOf("?")
if(-1!==V?(this.search=r.substr(V),this.query=r.substr(V+1),e&&(this.query=N.parse(this.query)),r=r.slice(0,V)):e&&(this.search="",this.query={}),r&&(this.pathname=r),S[o]&&this.hostname&&!this.pathname&&(this.pathname="/"),this.pathname||this.search){var B=this.pathname||"",F=this.search||""
